...
public class helper {
	...
	public static BufferedImage workOnImage(matrix myMatrix, int yMatrix, int xMatrix,
			BufferedImage sourceImg, int xWorkingPixel, int yWokringPixel, int grayLevelOldPixel) {
